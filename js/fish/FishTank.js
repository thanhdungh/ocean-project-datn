...
class FishTank {
    constructor(app) {
        ...
        App3.startLoadPhase()
        App3.glbLoader.load(app.assetRoot + "models/fishs/waterdunes.glb", (gltf) => {
            let m
            ...
            new THREE.TextureLoader().load(`models/fishs/background.jpg`, (tex) => {
            ...
            */
            ...
            App3.glbLoader.load(app.assetRoot + "models/fishs/coral.glb", async (coralGltf) => {
